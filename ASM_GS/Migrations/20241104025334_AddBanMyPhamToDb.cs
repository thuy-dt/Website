...
namespace ASM_GS.Migrations
{
    ...
    public partial class AddBanMyPhamToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "MaTaiKhoan", "Email", "MaKhachHang", "MaNhanVien", "MaNhanVienNavigationMaNhanVien", "MatKhau", "TenTaiKhoan", "VaiTro" },
                values: new object[,]
                {
                    { "TK001", "customer1@example.com", "KH001", null, null, "123", "customer1", "Customer" },
                    { "TK002", "customer2@example.com", "KH002", null, null, "123", "customer2", "Customer" }
                });
